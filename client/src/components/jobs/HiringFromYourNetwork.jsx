...
export default function HiringFromYourNetwork() {
  return (
    <>
      <div className="p-5">
        <p className="font-semibold">Hiring from your network</p>
        <p className="text-gray-400 text-sm">Explore relevant jobs in your network</p>
