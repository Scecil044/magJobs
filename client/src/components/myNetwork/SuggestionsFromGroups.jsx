...
const mock = [
  ...
  },
  {
    firstName: "Junior",
    lastName: "Steph",
    avatar: "https://randomuser.me/portraits/men/28.jpg",
    career: "software developer"
  },
  {
    firstName: "Stephanie",
  ...
  },
  {
    firstName: "Andy",
    lastName: "Annete",
    avatar: "https://randomuser.me/portraits/women/20.jpg",
    career: "software developer"
  },
  {
    firstName: "Rose",
    lastName: "Ty",
    avatar: "https://randomuser.me/portraits/women/90.jpg",
    career: "software developer"
  },
  {
    firstName: "Emmanuel",
    lastName: "Oronje",
    avatar: "https://randomuser.me/portraits/men/69.jpg",
...
export default function SuggestionsFromGroups({ users = mock }) {
  return (
    <>
      <div>
        <div className="flex items-center justify-between">
          <div className="text-gray-400 text-sm">
            <p>People you may know in React js developers India</p>
          </div>
