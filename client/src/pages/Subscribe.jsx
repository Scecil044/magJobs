          ...
          <div className="w-[360px] flex flex-col gap-5">
            <div className="bg-white shadow-lg rounded-lg border border-gray-400 p-5">
              ...
              <p className="text-xs text-gray-400 mt-5">
                ...
                Purchases to cancel before November 02, 2023 and your card won’t be charged. We can’t issue refunds once your
                card is charged
              </p>
            </div>
            <div className="bg-white shadow-lg rounded-lg border border-gray-400 flex gap-2 overflow-hidden">
              ...
              <div className="text-xs mt-3 pr-5 pl-5">
                <p className="line-clamp-4">
                  The courses I took taught me how to turn theory into concrete & systematic practice. Coursera has been
                  paramount to the advancement of my career.
                </p>
